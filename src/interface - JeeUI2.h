...
inline void interface(){ // Декларатиынве функции интерфейса
    ...
    UI_MENU("Реле RS485");
    UI_MENU("WiFi Settings");
    UI_MENU("Statistics");
    UI_MENU("Профиль");
    UI_MENU("Настройка MQTT");
    ...
    UI_DISPLAY("CleanLogicInfo", CleanLogicInfo, "ℹ️ Логика промывки и RS485");
...
UI_COLOR("LEDColor", LEDColor, "🎨 Цвет подсветки");
   ...
   static const std::initializer_list<UIOption> dosingOptions{  {"1", "5 сек / 15 сек"},
                                                                {"2", "5 сек / 60 сек"},
                                                                {"3", "5 сек / 5 мин"},
                                                                {"4", "5 сек / 15 мин"},
                                                                {"5", "5 сек / 30 мин"},
       ...
       UI_DISPLAY("PhLogicInfo", PhLogicInfo, "ℹ️ Логика pH и RS485");
        ...
        // Все Web-графики используют общие ограничения: минимум 5 секунд, максимум 24 часа,
...
UI_BUTTON("Pow_Ul_light", Pow_Ul_light, "gray", "🚏 Включить/Отключить освещение вручную");
    ...
    //Реле RS485
    UI_PAGE();
    UI_RS485_PANEL("Rs485Panel", "/huaqingjun.jpg", "RS485 16CH + DI16");

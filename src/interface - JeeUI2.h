...
inline void interface(){ // Декларатиынве функции интерфейса
    ...
    UI_DISPLAY_BOOL("WaterLevelSensorUpper", WaterLevelSensorUpper, "⬆️ Состояние датчика верхнего уровня", "✅ Активен", "⏹️ Откл.");
    UI_DISPLAY_BOOL("WaterLevelSensorLower", WaterLevelSensorLower, "⬇️ Состояние датчика нижнего уровня", "✅ Активен", "⏹️ Откл.");

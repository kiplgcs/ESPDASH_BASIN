...
inline void interface(){ // Декларатиынве функции интерфейса
    ...
    UI_CHECKBOX("Clean_Time1", Clean_Time1, "🗓️ Активировать ромывку по времени");
    ...
    UI_BUTTON("SolSandDump", SolSandDump, "gray", "🔘 Включение соленоида сброса песка после промывки");

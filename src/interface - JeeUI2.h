...
inline void interface(){ // Декларатиынве функции интерфейса
    ...
    UI_BUTTON("SolSandDump", SolSandDump, "gray", "🔘 Соленоида сброса песка с водой после промывки"); //включаем реле соленоида воды по RS-485 (выбрать свободное реле от №9 до №16)

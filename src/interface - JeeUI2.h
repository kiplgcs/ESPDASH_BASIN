...
inline void interface(){ // Декларатиынве функции интерфейса
    ...
    UI_BUTTON("AirPump", AirPump, "gray", "🔘 Компрессора воздуха для приводов клапанов");
    //UI_BUTTON("SolValveFilBack", SolValveFilBack, "gray", "🔘 Соленоид трехходовых клапанов Фильтрации / Промывки");
    UI_BUTTON("SolSandDump", SolSandDump, "gray", "🔘 Соленоида сброса песка после промывки");
